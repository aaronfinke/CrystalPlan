...
import utils
import goniometers
from goniometers import LimitedGoniometer as LG
#--- Traits Imports ---
...
class LimitedGoniometer(Goniometer):
    ...
    def _angle_fitness_brute(self, rot_angle_list, initial_rotation_matrix, ending_vec, starting_vec):
        ...
        try:
            g = getattr(sys.modules['goniometers'], type(self).__name__)
            go = g()
        except:
            print(f'gonio {type(self).__name__} not found, using LimitedGoniometer')
